...
const (
	Dictionary_GetDictionary_FullMethodName    = "/configure.api.configure.dictionary.v1.Dictionary/GetDictionary"
	Dictionary_ListDictionary_FullMethodName   = "/configure.api.configure.dictionary.v1.Dictionary/ListDictionary"
	Dictionary_CreateDictionary_FullMethodName = "/configure.api.configure.dictionary.v1.Dictionary/CreateDictionary"
	Dictionary_UpdateDictionary_FullMethodName = "/configure.api.configure.dictionary.v1.Dictionary/UpdateDictionary"
	Dictionary_DeleteDictionary_FullMethodName = "/configure.api.configure.dictionary.v1.Dictionary/DeleteDictionary"
)
...
var Dictionary_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "configure.api.configure.dictionary.v1.Dictionary",
	...
	Metadata: "api/configure/dictionary/layout_dictionary_service.proto",
}
