...
const OperationDictionaryCreateDictionary = "/configure.api.configure.dictionary.v1.Dictionary/CreateDictionary"
const OperationDictionaryDeleteDictionary = "/configure.api.configure.dictionary.v1.Dictionary/DeleteDictionary"
const OperationDictionaryGetDictionary = "/configure.api.configure.dictionary.v1.Dictionary/GetDictionary"
const OperationDictionaryListDictionary = "/configure.api.configure.dictionary.v1.Dictionary/ListDictionary"
const OperationDictionaryUpdateDictionary = "/configure.api.configure.dictionary.v1.Dictionary/UpdateDictionary"
...
func RegisterDictionaryHTTPServer(s *http.Server, srv DictionaryHTTPServer) {
	r := s.Route("/")
	r.GET("/configure/api/v1/dictionary", _Dictionary_GetDictionary0_HTTP_Handler(srv))
	r.GET("/configure/api/v1/dictionaries", _Dictionary_ListDictionary0_HTTP_Handler(srv))
	r.POST("/configure/api/v1/dictionary", _Dictionary_CreateDictionary0_HTTP_Handler(srv))
	r.PUT("/configure/api/v1/dictionary", _Dictionary_UpdateDictionary0_HTTP_Handler(srv))
	r.DELETE("/configure/api/v1/dictionary", _Dictionary_DeleteDictionary0_HTTP_Handler(srv))
}
...
func (c *DictionaryHTTPClientImpl) CreateDictionary(ctx context.Context, in *CreateDictionaryRequest, opts ...http.CallOption) (*CreateDictionaryReply, error) {
	...
	pattern := "/configure/api/v1/dictionary"
...
func (c *DictionaryHTTPClientImpl) ListDictionary(ctx context.Context, in *ListDictionaryRequest, opts ...http.CallOption) (*ListDictionaryReply, error) {
	...
	pattern := "/configure/api/v1/dictionaries"
	path := binding.EncodeURL(pattern, in, true)
